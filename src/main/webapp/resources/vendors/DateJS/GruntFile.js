...
module.exports = function(grunt) {
	...
	grunt.initConfig({
		...
		build_prod: {
			description: "Builds views ready files (minified)"
		},
		closurecompiler: {
			minify: {
	...
	grunt.registerMultiTask("build_prod", "Rebuilds dev and minifies files for views enviroments", function() {
